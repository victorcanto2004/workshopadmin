 ...
 * @author canto
 */
public class JFDocenConsultarAlumnos extends javax.swing.JFrame {
    private Carnet carnetGen;
    /**
     * Creates new form JFConsultarAlumno
     */
    
    public JFDocenConsultarAlumnos() {
...
public PdfPTable crearTablaDesdeJTable(JTable jTable) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFDocenConsultarAlumnos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFDocenConsultarAlumnos().setVisible(true);
            }
        });
    }
