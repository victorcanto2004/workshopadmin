 ...
 * @author canto
 */
public class JFDocenteModificarGrupos extends javax.swing.JFrame {

    /**
     * Creates new form JFModificarGrupos
     */
    public JFDocenteModificarGrupos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Actualizar datos de grupos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFDocenteModificarGrupos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFDocenteModificarGrupos().setVisible(true);
            }
        });
    }
