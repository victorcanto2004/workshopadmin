 ...
 * @author canto
 */
public class JFDocenModificarAlumnos extends javax.swing.JFrame {
     ...
     */
    public JFDocenModificarAlumnos() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFDocenModificarAlumnos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFDocenModificarAlumnos().setVisible(true);
            }
        });
    }
