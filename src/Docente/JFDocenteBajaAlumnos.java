 ...
 * @author canto
 */
public class JFDocenteBajaAlumnos extends javax.swing.JFrame {

    /**
     * Creates new form JFBajaAlumnos
     */
    public JFDocenteBajaAlumnos() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFDocenteBajaAlumnos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFDocenteBajaAlumnos().setVisible(true);
            }
        });
    }
