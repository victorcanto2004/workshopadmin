 ...
 * @author canto
 */
public class JFDocenteAltaAlumnos extends javax.swing.JFrame {

    /**
     * Creates new form JFMaestro
     */
    public JFDocenteAltaAlumnos() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFDocenteAltaAlumnos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFDocenteAltaAlumnos().setVisible(true);
            }
        });
    }
