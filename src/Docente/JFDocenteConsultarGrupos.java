 ...
 * @author canto
 */
public class JFDocenteConsultarGrupos extends javax.swing.JFrame {

    /**
     * Creates new form JFCosultarGrupos
     */
    public JFDocenteConsultarGrupos() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFDocenteConsultarGrupos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFDocenteConsultarGrupos().setVisible(true);
            }
        });
    }
