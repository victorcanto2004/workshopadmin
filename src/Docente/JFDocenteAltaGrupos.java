 ...
 * @author canto
 */
public class JFDocenteAltaGrupos extends javax.swing.JFrame {

    /**
     * Creates new form JFAltaGrupos
     */
    public JFDocenteAltaGrupos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Registra un grupo");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFDocenteAltaGrupos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFDocenteAltaGrupos().setVisible(true);
            }
        });
    }
