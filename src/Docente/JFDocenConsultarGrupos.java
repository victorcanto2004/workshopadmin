 ...
 * @author canto
 */
public class JFDocenConsultarGrupos extends javax.swing.JFrame {
    ...
    private void jButtonRegresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRegresarActionPerformed
        ...
        JFDocenAdministrarGrupos.setVisible(true); // Muestra la ventana de inicio
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFDocenConsultarGrupos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFDocenConsultarGrupos().setVisible(true);
            }
        });
    }
